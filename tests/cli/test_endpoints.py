...
class TestCommand(DeprecatedPublisherCliTestCase):
    ...
    def test_happy_path(self):
        ...
        self.expect_error_from(
            ["config", "endpoints", "add", "sample-viral-ai", "-t", "collections"],
        ...
        self.expect_error_from(
            ["config", "endpoints", "set", "sample-viral-ai", "foo.bar", "panda"],
        ...
        self.expect_error_from(
            ["config", "endpoints", "set", "snake", "foo.bar", "panda"], error_message="EndpointNotFound: snake"
        )
        ...
        self.expect_error_from(
            ["config", "endpoints", "set", "sample-data-connect", "authentication.foo_bar", "panda"],
