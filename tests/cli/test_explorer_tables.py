...
class TestExplorerTables(unittest.TestCase):
    def setUp(self):
        ...
        self.sample_questions = [
            FederatedQuestion(
                ...
                params=[
                    QuestionParam(name="param1", description="Required parameter", input_type="string", required=True),
                    QuestionParam(
                        name="param2", description="Optional parameter", input_type="integer", required=False
                    ),
                ],
                collections=[QuestionCollection(slug="collection1"), QuestionCollection(slug="collection2")],
            ),
            FederatedQuestion(
                id="q2",
                ...
                params=[
                    QuestionParam(name="param3", description="Another parameter", input_type="boolean", required=True)
                ],
                collections=[QuestionCollection(slug="collection3")],
            ),
        ]
    ...
    def test_format_question_list_table_no_params(self):
        ...
        question = FederatedQuestion(
            id="q3", name="No Params Question", description="Question without parameters", params=[], collections=[]
        )
