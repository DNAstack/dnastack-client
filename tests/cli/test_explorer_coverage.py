...
class TestExplorerCoverage(unittest.TestCase):
    ...
    def test_format_question_collections_with_data(self):
        ...
        collections = [QuestionCollection(id="123", name="Test Collection", slug="test_collection", question_id="q1")]
    ...
    def test_format_question_detail_with_collections(self):
        ...
        question = FederatedQuestion(
            ...
            collections=[QuestionCollection(id="1", name="Collection 1", slug="collection1", question_id="detailed_q")],
        )
    ...
    def test_format_question_results_with_complex_list(self):
        ...
        results = [
            {"simple": "value", "complex_list": [{"nested": {"deep": "value1"}}, {"nested": {"deep": "value2"}}]}
        ]
    ...
    def test_flatten_dict_with_mixed_list(self):
        ...
        d = {"simple_list": ["a", "b", "c"], "complex_list": [{"key": "val1"}, {"key": "val2"}], "empty_list": []}
    ...
    def test_validate_question_parameters_with_partial_match(self):
        ...
        question = FederatedQuestion(
            ...
            description="Test",
            params=[
                QuestionParam(name="required_param", description="Required", input_type="string", required=True),
                QuestionParam(name="optional_param", description="Optional", input_type="string", required=False),
            ],
            collections=[],
        )
