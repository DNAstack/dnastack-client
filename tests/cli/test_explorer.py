...
from dnastack.client.explorer.models import FederatedQuestion, QuestionCollection, QuestionParam
...
class ExplorerCliTestCase(CliTestCase):
    def setUp(self):
        ...
        self.sample_question = FederatedQuestion(
            ...
            params=[QuestionParam(name="param1", description="Test parameter", type="string", required=True)],
            collections=[QuestionCollection(slug="collection1")],
        )
    ...
    def test_explorer_questions_list(self, mock_factory):
        ...
        # Run the command
        result = self._runner.invoke(self.cli_app, ["explorer", "questions", "list"])
    ...
    def test_explorer_questions_describe(self, mock_factory):
        ...
        # Run the command
        result = self._runner.invoke(self.cli_app, ["explorer", "questions", "describe", "q1"])
    ...
    def test_explorer_questions_ask(self, mock_factory):
        ...
        # Run the command
        result = self._runner.invoke(self.cli_app, ["explorer", "questions", "ask", "--question-name", "q1"])
    ...
    def test_explorer_questions_ask_with_args(self, mock_factory):
        ...
        result = self._runner.invoke(
            self.cli_app, ["explorer", "questions", "ask", "--question-name", "q1", "--param", "param1=test_value"]
        )
    ...
    def test_explorer_questions_list_json_output(self, mock_factory):
        ...
        result = self._runner.invoke(self.cli_app, ["explorer", "questions", "list", "--output-format", "json"])
...
class TestExplorerCliFlags(CliTestCase):
    ...
    def setUp(self):
        ...
        self.sample_question = FederatedQuestion(
            ...
            name="Test Question",
            description="A test question",
            params=[QuestionParam(name="param1", description="Test parameter", input_type="string", required=True)],
            collections=[
                QuestionCollection(id="collection1", name="Collection 1", slug="collection-1", question_id="q1")
            ],
        )
    ...
    def test_ask_question_multiple_param_flags(self, mock_factory):
        ...
        question_with_multiple_params = FederatedQuestion(
            ...
            description="A test question",
            params=[
                QuestionParam(name="param1", description="Test parameter 1", input_type="string", required=True),
                QuestionParam(name="param2", description="Test parameter 2", input_type="string", required=False),
            ],
            collections=[
                QuestionCollection(id="collection1", name="Collection 1", slug="collection-1", question_id="q1")
            ],
    ...
    def test_ask_question_param_flag_parsing(self, mock_factory):
        ...
        result = self._runner.invoke(
            self.cli_app,
            ["explorer", "questions", "ask", "--question-name", "q1", "--param", "param1=complex_value_with_spaces"],
        )
    ...
    def test_ask_question_param_help_text(self):
        ...
        result = self._runner.invoke(self.cli_app, ["explorer", "questions", "ask", "--help"])
...
class TestExplorerOutputBehavior(CliTestCase):
    ...
    def test_ask_question_empty_results_json_output(self, mock_factory):
        ...
        # Run the command with JSON output
        result = self._runner.invoke(
            self.cli_app, ["explorer", "questions", "ask", "--question-name", "q1", "--output-format", "json"]
        )
    ...
    def test_ask_question_empty_results_yaml_output(self, mock_factory):
        ...
        result = self._runner.invoke(
            self.cli_app, ["explorer", "questions", "ask", "--question-name", "q1", "--output-format", "yaml"]
        )
