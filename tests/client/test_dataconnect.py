...
from dnastack.client.data_connect import InvalidDataLoadingError, InvalidQueryError, QueryLoader
from dnastack.common.logger import get_logger
from tests.exam_helper import DataConversionSample, DeprecatedBasePublisherTestCase, measure_runtime
...
class TestUnit(DeprecatedBasePublisherTestCase):
    ...
    def test_data_conversion_in_query_loader(self):
        samples = (
            ...
            DataConversionSample.time("12:34:56", [lambda ts: self.assertEqual(ts.microsecond, 0)]),
            DataConversionSample.time("23:45:01.234", [lambda ts: self.assertEqual(ts.microsecond, 234000)]),
            DataConversionSample.time("23:45:01.234567", [lambda ts: self.assertEqual(ts.microsecond, 234567)]),
            # Time with time zone
            DataConversionSample.time_with_time_zone("12:34:56Z", [self.__assert_utc_time_zone]),
            DataConversionSample.time_with_time_zone("12:34:56-01", [self.__make_tzinfo_checker("UTC-01:00")]),
            DataConversionSample.time_with_time_zone("12:34:56+01", [self.__make_tzinfo_checker("UTC+01:00")]),
            DataConversionSample.time_with_time_zone("12:34:56-02:34", [self.__make_tzinfo_checker("UTC-02:34")]),
            DataConversionSample.time_with_time_zone("12:34:56+02:34", [self.__make_tzinfo_checker("UTC+02:34")]),
            DataConversionSample.time_with_time_zone("23:45:01.234Z", [self.__assert_utc_time_zone]),
            DataConversionSample.time_with_time_zone("23:45:01.234-01", [self.__make_tzinfo_checker("UTC-01:00")]),
            DataConversionSample.time_with_time_zone("23:45:01.234+01", [self.__make_tzinfo_checker("UTC+01:00")]),
            DataConversionSample.time_with_time_zone("23:45:01.234-02:34", [self.__make_tzinfo_checker("UTC-02:34")]),
            DataConversionSample.time_with_time_zone("23:45:01.234+02:34", [self.__make_tzinfo_checker("UTC+02:34")]),
            DataConversionSample.time_with_time_zone("23:45:01.234567Z", [self.__assert_utc_time_zone]),
            DataConversionSample.time_with_time_zone("23:45:01.234567-01", [self.__make_tzinfo_checker("UTC-01:00")]),
            DataConversionSample.time_with_time_zone("23:45:01.234567+01", [self.__make_tzinfo_checker("UTC+01:00")]),
            DataConversionSample.time_with_time_zone(
                "23:45:01.234567-02:34", [self.__make_tzinfo_checker("UTC-02:34")]
            ),
            DataConversionSample.time_with_time_zone(
                "23:45:01.234567+02:34", [self.__make_tzinfo_checker("UTC+02:34")]
            ),
            ...
            DataConversionSample.timestamp(
                "2345-06-07 12:34:56", [lambda ts: self.assertEqual(ts.time().microsecond, 0)]
            ),
            DataConversionSample.timestamp(
                "2345-06-07T23:45:01.234", [lambda ts: self.assertEqual(ts.time().microsecond, 234000)]
            ),
            DataConversionSample.timestamp(
                "2345-06-07 23:45:01.234567", [lambda ts: self.assertEqual(ts.time().microsecond, 234567)]
            ),
            # Timestamp with time zone
            # NOTE: The samples are mixed with both "<date>T<time><tz>" and "<date> <time><tz>" of ISO 8601.
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07 12:34:56Z",
                [lambda ts: self.assertEqual(ts.time().microsecond, 0), self.__assert_utc_time_zone],
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07T12:34:56-01", [self.__make_tzinfo_checker("UTC-01:00")]
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07 12:34:56+01", [self.__make_tzinfo_checker("UTC+01:00")]
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07T12:34:56-02:34", [self.__make_tzinfo_checker("UTC-02:34")]
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07 12:34:56+02:34", [self.__make_tzinfo_checker("UTC+02:34")]
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07T23:45:01.234Z",
                [lambda ts: self.assertEqual(ts.time().microsecond, 234000), self.__assert_utc_time_zone],
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07 23:45:01.234-01", [self.__make_tzinfo_checker("UTC-01:00")]
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07T23:45:01.234+01", [self.__make_tzinfo_checker("UTC+01:00")]
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07 23:45:01.234-02:34", [self.__make_tzinfo_checker("UTC-02:34")]
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07T23:45:01.234+02:34", [self.__make_tzinfo_checker("UTC+02:34")]
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07 23:45:01.234567Z",
                [lambda ts: self.assertEqual(ts.time().microsecond, 234567), self.__assert_utc_time_zone],
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07T23:45:01.234567-01", [self.__make_tzinfo_checker("UTC-01:00")]
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07 23:45:01.234567+01", [self.__make_tzinfo_checker("UTC+01:00")]
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07T23:45:01.234567-02:34", [self.__make_tzinfo_checker("UTC-02:34")]
            ),
            DataConversionSample.timestamp_with_time_zone(
                "2345-06-07 23:45:01.234567+02:34", [self.__make_tzinfo_checker("UTC+02:34")]
            ),
        ...
        mock_response.json.return_value = {
            "data_model": {"properties": {sample.id: sample.get_schema() for sample in samples}},
            "data": [{sample.id: sample.content for sample in samples}],
        }
...
class TestEndToEnd(DeprecatedBasePublisherTestCase, DataConnectTestCaseMixin):
    ...
    def test_auth_client_interacts_with_data_connect_service(self):
        ...
        for table in [client.table(t) for t in tables]:
            ...
            try:
                ...
                self.fail(f"Unexpected exception type: {type(e).__module__}.{type(e).__name__}: {e}")
    ...
    def test_auth_client_interacts_with_data_connect_service_with_no_auth(self):
        collections = [
            c.slugName
            for c in self.get_factory().get("collection-service").list_collections()
        ...
        while True:
            ...
            try:
                ...
                self._logger.debug(
                    f"E/{client.endpoint.id}: This endpoint allows clients to list tables without "
                ...
                if e.status in (401, 403):
                    self._logger.debug(
                        f"E/{client.endpoint.id}: This endpoint responds to an anonymous list-table "
