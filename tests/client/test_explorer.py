...
class TestExplorerClient(unittest.TestCase):
    def setUp(self):
        ...
        # Create client
        self.client = ExplorerClient(session=self.mock_session, endpoint=self.mock_endpoint)
        ...
        self.sample_question_data = {
            ...
            "params": [{"name": "param1", "description": "Test parameter", "input_type": "string", "required": True}],
            "collections": [{"slug": "collection1"}],
        }
    ...
    def test_list_federated_questions(self, mock_result_loader):
        ...
        # Mock the response
        mock_response = Mock()
        mock_response.json.return_value = {"questions": [self.sample_question_data]}
        ...
        self.mock_session.get.assert_called_once_with(f"{self.mock_endpoint.url}/questions")
    ...
    def test_describe_federated_question(self):
        ...
        # Verify the session was called correctly
        self.mock_session.get.assert_called_once_with(f"{self.mock_endpoint.url}/questions/q1")
    ...
    def test_ask_federated_question_basic(self, mock_result_loader):
        ...
        # Verify the session was called correctly
        self.mock_session.post.assert_called_once_with(f"{self.mock_endpoint.url}/questions/q1/ask", json={})
    ...
    def test_ask_federated_question_with_args(self, mock_result_loader):
        ...
        self.mock_session.post.assert_called_once_with(
            f"{self.mock_endpoint.url}/questions/q1/ask", json=expected_payload
        )
    ...
    def test_ask_federated_question_with_all_params(self, mock_result_loader):
        ...
        # Verify the session was called correctly
        expected_payload = {"args": args, "collections": collections}
        self.mock_session.post.assert_called_once_with(
            f"{self.mock_endpoint.url}/questions/q1/ask", json=expected_payload
        )
    ...
    def test_describe_federated_question_with_complex_data(self):
        ...
        complex_question_data = {
            ...
            "collections": [{"slug": "collection1"}, {"slug": "collection2"}, {"slug": "collection3"}],
        }
    ...
    def test_endpoint_url_construction(self):
        ...
        self.mock_session.get.assert_called_once_with("https://example.com/api/questions/test_id")
