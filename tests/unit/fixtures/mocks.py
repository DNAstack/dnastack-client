...
class MockResponse:
    ...
    def __init__(self, json_data: Optional[Dict[str, Any]] = None, status_code: int = 200, text: str = ""):
...
class MockServiceRegistry:
    ...
    def add_service(self, service_id: str, name: str, service_type: str, url: str):
        ...
        service = Service(
            id=service_id, name=name, type=ServiceType(group=group, artifact=artifact, version=version), url=url
        )
...
class MockCollectionServiceClient:
    ...
    def create_collection(self, name: str, description: str = None) -> Dict[str, Any]:
        ...
        collection = {"id": collection_id, "name": name, "description": description or "", "items": []}
