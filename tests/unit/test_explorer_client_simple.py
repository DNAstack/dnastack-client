...
class TestExplorerClientSimple(unittest.TestCase):
    ...
    def test_ask_federated_question_method(self, mock_describe, mock_create_session):
        ...
        collection = QuestionCollection(id="c1", name="Collection 1", slug="collection-1", questionId="q1")
        ...
        result_iter = client.ask_federated_question(question_id="q1", inputs={"param1": "value1"})
        ...
        result_iter2 = client.ask_federated_question(
            question_id="q1", inputs={"param1": "value1"}, collections=["c1", "c2"]
        )
    ...
    def test_federated_question_list_result_loader_basic(self):
        ...
        loader = FederatedQuestionListResultLoader(
            service_url="https://example.com/questions", http_session=mock_session
        )
    ...
    def test_federated_question_query_result_loader_basic(self):
        ...
        request_payload = FederatedQuestionQueryRequest(inputs={"param1": "value1"}, collections=["c1"])
