...
class TestExplorerCommandsCoverage(unittest.TestCase):
    ...
    def test_commands_module_structure(self):
        ...
        from dnastack.cli.commands.explorer.commands import explorer_command_group, questions_command_group
    ...
    def test_list_questions_execution(self, mock_span, mock_show_iterator, mock_get_client):
        ...
        test_question = FederatedQuestion(id="q1", name="Test Question", description="Test", params=[], collections=[])
    ...
    def test_ask_question_validation_error(self, mock_span, mock_echo, mock_get_client):
        ...
        test_question = FederatedQuestion(
            id="q1", name="Test Question", description="Test", params=[required_param], collections=[]
        )
    ...
    def test_ask_question_invalid_collections(self, mock_span, mock_echo, mock_get_client):
        ...
        collection = QuestionCollection(
            id="valid_collection", name="Valid Collection", slug="valid-collection", questionId="q1"
        )

        test_question = FederatedQuestion(
            id="q1", name="Test Question", description="Test", params=[], collections=[collection]
        )
        ...
        result = runner.invoke(
            ask_cmd, ["--question-name", "q1", "--collections", "invalid_collection", "--output", "json"]
        )
