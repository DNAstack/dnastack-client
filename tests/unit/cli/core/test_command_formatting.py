...
class TestFormattedHelpCommand(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.command = FormattedHelpCommand(name="test-command", help="A test command for unit testing")
    ...
    def test_constants_calculation_in_methods(self):
        ...
        from dnastack.cli.core.constants import INDENT, OPTION_PADDING, OPTION_WIDTH, TOTAL_WIDTH
