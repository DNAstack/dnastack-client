...
class TestExplorerSimpleCoverage(unittest.TestCase):
    ...
    def test_tables_functions_comprehensive(self):
        ...
        question = FederatedQuestion(
            id="q1", name="Test Question", description="A test question", params=[param], collections=[collection]
        )
    ...
    def test_utils_functions_comprehensive(self):
        ...
        from dnastack.client.explorer.models import QuestionCollection, QuestionParam
        ...
        param = QuestionParam(
            id="1", name="test_param", label="Test Parameter", inputType="string", description="A test parameter"
        )
    ...
    def test_validation_function(self):
        ...
        question_no_params = FederatedQuestion(id="q1", name="Test", description="Test", params=[], collections=[])
        ...
        required_param = QuestionParam(
            id="1", name="required_param", label="Required", inputType="string", required=True
        )

        question_with_required = FederatedQuestion(
            id="q1", name="Test", description="Test", params=[required_param], collections=[]
        )
