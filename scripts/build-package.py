...
def main():
    ...
    if in_dry_run_mode:
        ...
        install_build_tool_dependency("build>=0.7.0", "setuptools>=49.2.1")
        ...
        changes = [
            ...
            for change_type, file_path in [
                ...
                for line in subprocess.check_output(
                    ["git", "status", "--short", "-uno"], universal_newlines=True
                ).split("\n")
                if line
            ]
    ...
    with open("dnastack/constants.py") as f:
        content = f.read()
    ...
    if in_dry_run_mode:
        ...
        with open(setup_temp_file) as f:
