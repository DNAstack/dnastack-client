...
@formatted_command(
    ...
    name="use",
    specs=[ArgumentSpec(name="context_name", arg_names=["--name"], help="Context name -- default to hostname")],
)
...
@formatted_command(group=contexts_command_group, name="list", specs=[RESOURCE_OUTPUT_ARG])
