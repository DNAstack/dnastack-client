...
from dnastack.cli.commands.publisher.datasources.utils import _filter_datasource_fields, _get_datasource_client
...
def init_datasources_commands(group: Group):
    ...
    def list_datasources(output: Optional[str] = None, type: Optional[str] = None):
        ...
        with Span("list_datasources") as span:
            ...
            show_iterator(output, [_filter_datasource_fields(datasource.dict()) for datasource in response.connections])
